...
var _minggu = 'Rp Gopek' //Masukkan harga sewa sesuai keinginan
var __minggu = 'Rp Limpul'
var ___minggu = 'Rp Goceng'
var _bulan = 'Rp Cepek'
var _permanen = 'Rp Gratis'
var __permanen = 'Pap Tetek Dulu'
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const alphaNumber = [`628566732166@s.whatsapp.net`, `6285277911718@s.whatsapp.net` ]
...
const bugtrol = { 
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "628566732166@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
						...
						"message": `${creator}`,
						"orderTitle": `${creator}`,
						"sellerJid": "628566732166@s.whatsapp.net",
...
let id_vote = sender ? sender : '628566732166@s.whatsapp.net'
...
*☠️ Sisa Balance : $${getBalance(sender, balance)}*
...
`
if(menusimple == false){
sendButDoc(from, ini_anu, `Jangan Spam Yah Kontollllll!!!!!!.\n𝐓𝐡𝐚𝐧𝐤??!`, sender, koko, ini_mark)
...
const buttons1 = [
  {buttonId: 'ownerku', buttonText: {displayText: '⋮😈 OWNER GW'}, type: 1},
  {buttonId: 'statiktiknya', buttonText:{displayText: '☠️ STATISTIC BOT'}, type: 1},
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					ini_list.push({
					"displayName": 'Owner Fathur',
					"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${vname ? `${vname}` : `${alpha.user.name}`}\nORG: JAN LUPA PAP TETE;\nitem1.TEL;waid=${i.split('@')[0]}:${i.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`
					})
					}
...
break
		     ...
		     if (!isGroup) return fakegroup(lang.onlygc())
							...
							if (args[0] === 'add') {
								if (mek.message.extendedTextMessage != undefined) {
									...
									reply(`*「 PREMIUM ADDED 」*\n\n🤡 *ID*: ${mentioned[0]}\n👻 *Expired*: ${ms(toMs(args[2])).days} day(s) ${ms(toMs(args[2])).hours} hour(s) ${ms(toMs(args[2])).minutes} minute(s)`)
										...
										reply(`*「 PREMIUM ADDED 」*\n\n🤡 *ID*: ${args[1]}@s.whatsapp.net\n☠️ *Expired*: ${ms(toMs(args[2])).days} day(s) ${ms(toMs(args[2])).hours} hour(s) ${ms(toMs(args[2])).minutes} minute(s)`)
										}
										} else if (args[0] === 'del') {
											if (mek.message.extendedTextMessage != undefined) {
									mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
				...
				case 'listprem': case 'listpremium':
							...
							for (let i of _premium){
								...
								txt += `🤡 *ID :* @${i.id.split("@")[0]}\n☠️ *Expired*: ${checkExp.days} day(s) ${checkExp.hours} hour(s) ${checkExp.minutes} minute(s)\n\n`
								}
		...
		if (!isQuotedSticker) return reply('Reply stc nya!')
					...
					fakethumb(buffer,'```Nih kak, jgn lupa PAP TETE KAK```')
					fs.unlinkSync(ran)
					})
					break
...
*/
			...
			if (!isGroup) return reply(lang.onlygc())
					...
					if (args[0].startsWith('08')) return reply('Gunakan kode negara Goblok')
					orang = args[0] + '@s.whatsapp.net'
response = await alpha.groupAdd(from, [orang])
o = response.participants[0]
let inv = (Object.values(o))
if(inv[0].code == 409) return reply('Orang yang anda add sudah ada didalam Group Tolol!')
...
if (!isGroup) return reply(lang.onlygc())
 ...
 if (!isGroup) return reply(lang.onlygc())
        ...
        break;
			case 'admin':
					if (!isGroup) return fakestatus('```KHUSUS GRUP TOLOL```')
			...
			case 'tagall':
			if (!mek.key.fromMe && !isOwner && !isCreator) return reply(lang.onlyOwner())
			        if (!isGroupAdmins && !isBotGroupAdmins) return reply("Khusus Admin Goblok");
					members_id = []
            ...
            case 'leave':
					...
					fakestatus('```Byeee Teman Teman Ngentot🙏👋```')
					}, 0)
					break       
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
...
case 'tahta':  
     ...
     case 'nulis':
									...
									break
						case 'nuliskiri':{
									if (isLimit(sender, isPremium, isCreator, isOwner, limitawal, limit)) return reply (`Limit kamu sudah habis Tolloll ${prefix}limit untuk mengecek limit Anjing.`)
									...
									.on('exit', () => {
										alpha.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Nulis Ngentottt`})
						...
						case 'nuliskanan':{
									...
									.on('error', () => reply(lang.tryAgain()))
									.on('exit', () => {
										alpha.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Nulis Ngentot`})
										limitAdd(sender, limit)
										})
									}
									break
						case 'foliokiri':{
									...
									.on('error', () => reply(lang.tryAgain()))
									.on('exit', () => {
										alpha.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Nulis Ngentottt`})
										limitAdd(sender, limit)
										})
									}
									break
						case 'foliokanan':{
									...
									.on('exit', () => {
										alpha.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Nulis Ngentottt`})
										limitAdd(sender, limit)
									})
									}
									break      
...
break
		  ...
		  case 'tebakin': case 'tebakgambar':
                    ...
                    alpha.sendMessage(from, tebakya, image, { quoted: mek, caption: "Jawaban salah Harus Pap Tete " })
                   await sleep(30000)
...
${petik}☠️ Base : SELF-BOT${petik}
${petik}☠️ Lib : Baileys, 3.5.2${petik}
${petik}☠️ Prefix : ${prefix}${petik}
${petik}☠️ Versi Bot : v0.0.7${petik}
...
if (subscribezeeoneofc == "ownerku"){
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} itu owner ku, jangan lupa PAP TETE kak😤`
var buttonss = [
{buttonId: 'donasi', buttonText:{displayText: 'Donasi'}, type: 1},
...
•> Sewa Lonte : _1 Minggu_ 
•> Harga Lonte : ${_minggu}\n\nCaranya Coli :
1. Buka Hpmu.
2. Buka Celanamu
3. Buka Semvakmu .
4. Tonton Xnxx.com
5. Lalu ColiLah Sampai Kontolmu Crot`
...
if(subscribezeeoneofc == 'qr_ovo14'){
	...
	ini_bayar = `${ucapannya2}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
•> Sewa Lonte : _2 Minggu_ 
•> Harga Lonte : ${__minggu}\n\nCaranya Coli :
1. Buka Hpmu.
2. Buka Celanamu
3. Buka Semvakmu .
4. Tonton Xnxx.com
...
if(subscribezeeoneofc == 'qr_ovo15'){
	...
	ini_bayar = `${ucapannya2}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
•> Sewa Lonte : _3 Minggu_ 
•> Harga Lonte : ${___minggu}\n\nCaranya Coli :
1. Buka Hpmu.
2. Buka Celanamu
3. Buka Semvakmu .
4. Tonton Xnxx.com
...
if(subscribezeeoneofc == 'qr_ovo17'){
	...
	ini_bayar = `${ucapannya2}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
•> Sewa Lonte : _permanen_
•> Harga Lonte : ${_permanen}\n\nCaranya Coli :
1. Buka Hpmu.
2. Buka Celanamu
3. Buka Semvakmu .
4. Tonton Xnxx.com
